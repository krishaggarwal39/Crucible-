      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '24px' }}>
          <div className="glass" style={{ padding: '24px', borderRadius: '12px' }}>
            <div style={{ color: 'var(--text-tertiary)', fontSize: '0.875rem', marginBottom: '8px' }}>Average Score</div>
            <div style={{ fontSize: '2rem', fontWeight: 700 }}>
              {summary?.avg_drift_score != null ? summary.avg_drift_score.toFixed(1) : '—'}
            </div>
          </div>
          <div className="glass" style={{ padding: '24px', borderRadius: '12px' }}>
        ...
        <div className="glass" style={{ padding: '24px', borderRadius: '12px', height: '500px' }}>
          <h2 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '24px' }}>Behavioral Drift Over Time</h2>
            ...
            <div style={{ width: '100%', height: 'calc(100% - 48px)' }}>
              <ResponsiveContainer width="100%" height="100%">
                <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                  ...
                  <XAxis type="number" dataKey="x" name="Run Index" stroke="#888" tick={{fill: '#888'}} label={{ value: 'Run (newest → oldest)', position: 'bottom', fill: '#888' }} />
